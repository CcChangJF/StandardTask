...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        let link = profileUrl + "/profile/getTalentProfile";
        $.ajax({
            url: link,
            headers: {
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        let link = profileUrl + "/profile/updateTalentProfile";
        $.ajax({
            url: link,
            headers: {
                'Authorization': 'Bearer ' + cookies,
                                ...
                                <form className="ui form">
                                    <div className="ui grid">
                                        ...
                                        <Description
                                            ...
                                            updateProfile={this.updateWithoutSave}
                                            saveProfile={this.updateAndSaveData} />
                                        <FormItemWrapper
                                            title='User Details'
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl={profileUrl + '/profile/updateProfilePhoto'}
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={profileUrl + '/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={profileUrl + '/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                        <SelfIntroduction
                                            summary={this.state.profileData.summary}
